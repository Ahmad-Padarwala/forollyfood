            ...
            <div className="container-fluid footer-bg1">
                <div className="container">
                    <div className="row text-center py-5">
                        ...
                        <div>
                            <NavLink to="/inquiries" className='foot1-btn m-3'>Dealer Inquiry</NavLink>
                            <a href={require('../Assets/newpdf.pdf')} target="_blank" rel="noreferrer noopener" className="foot1-btn m-0">View Catalogue</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="container">
                        <div className="row py-5">
                            <div className="col-lg-3 col-md-6 mb-md-0 mb-4">
                                <img src={require('../Assets/images/footer-logo.webp')} alt="" className='img-fluid footer2-img' />
                                ...
                                <span className='footer-icon p-0'>
                                    <NavLink to="https://www.facebook.com/people/Forolly-Food-Products/100080207596150/" target="_blank" aria-label="Visit Forolly Food Products on Facebook" className="text-white">
                            ...
                            <div className="col-lg-2 col-md-6 mb-md-0 mb-4">
                            ...
                            <div className="col-lg-4 col-md-6 mt-md-5 mt-lg-0 mt-sm-5 mb-md-0 mb-4">
