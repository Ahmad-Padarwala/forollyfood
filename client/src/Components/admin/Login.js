...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    axios
      .get(`/users?uname=${uname.current.value}`)
      .then((response) => {
      ...
      <div className="card login-form-desig">
        <form className="box" onSubmit={handleLogin}>
          ...
          <input
            ...
            ref={password}
          />
          <NavLink className="forgot text-muted" to="/admin">
            Forgot password?
          </NavLink>
          ...
          <div className="col-md-12">
            <ul className="social-network social-circle">
              <li>
                <NavLink to="/admin" className="icoFacebook" title="Facebook">
                  <i className="fab fa-facebook-f"></i>
                </NavLink>
              </li>
              <li>
                <NavLink to="/admin" className="icoTwitter" title="Twitter">
                  <i className="fab fa-twitter"></i>
                </NavLink>
              </li>
              <li>
                <NavLink to="/admin" className="icoGoogle" title="Google +">
