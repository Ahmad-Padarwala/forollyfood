...
export default function AddNutr() {
  ...
  const saveNutrition = (e) => {
    e.preventDefault();
    axios
      .post(`/nutrition/${nutrId}`, nutrition)
      .then(() => {
          ...
          <div className="addMain p-4">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="form-control"
                name="saturated_fat"
                placeholder="Enter Saturated_fat"
                onChange={handleNutrChange}
              />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                placeholder="Enter Total_carbohydrates"
                onChange={handleNutrChange}
              />
            </div>
            <div className="mb-3">
