...
export default function ViewNutr() {
    ...
    const handleNutrDelete = () => {
        ...
        if (confirm) {
            axios.delete(`/nutrition/${getNutId}`)
                .then(() => {
                    navigate('/product');
                })
                .catch((error) => {
    ...
    const handleSaveNutrition = () => {
        axios.put(`/nutrition/${getNutId}`, editNutrition)
            .then((response) => {
    ...
    return (
        <>
            ...
            <div className='cate-main'>
                ...
                <div className='mt-2'>
                    <button className='btn btn-nutr-delete' onClick={handleNutrDelete}>
