            ...
            <div className="container-fluid welcome-bg">
                <div className="row p-lg-5 p-0 ps-md-5 ps-0">
                    <div className="col-lg-6 col-sm-12 text-center">
                        <img src={require('../Assets/images/about-welcome-img.webp')} alt=''
            ...
            <div className="container call-bg">
                <div className="row">
                    <div className="d-flex">
                        <span className="call-icon"><i className="fa-sharp fa-solid fa-phone"></i></span>
                        <span>
            ...
            <div className="container">
                ...
                <div className="row mb-5">
                    <div className="col-12 py-3 about-bg2">
                        <p className='about-para about-para2'>
